...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\nName: Divya Tiwari", font='Arial 16 ', fg='blue').pack()
        Label(root, text="\nEnrollment no. : 221B149", font='Arial 16 ', fg='blue').pack()
        Label(root, text="\nMobile : 6266193282\n\n\n", font='Arial 16 ', fg='blue').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<6:
                                                        ...
                                                        showerror("booking limit exceed","you can only book upto 5 seats at a time!")
                                                else:
